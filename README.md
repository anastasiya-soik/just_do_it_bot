...
- Daily fact pulled from a live web search (animal or historical, picked at random) at 10:00, plus `/fact` for one on demand
...
- Ежедневный факт через живой веб-поиск (про животных или исторический — случайно) в 10:00, плюс `/fact` по требованию
